...
@dso_cache = dso_local local_unnamed_addr global [636 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 344824576, ; hash 0x148d9b00, from name: libaot-Currency Change.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 793618304, ; hash 0x2f4da780, from name: Currency Change.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Currency Change.dll.so
		ptr null; void* handle (0x0)
	}, ; 104
	...
	%struct.DSOCacheEntry {
		i64 1070507247, ; hash 0x3fcea4ef, from name: aot-Currency Change.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Currency Change.dll.so
		ptr null; void* handle (0x0)
	}, ; 150
	...
	%struct.DSOCacheEntry {
		i64 1857681707, ; hash 0x6eb9f92b, from name: aot-Currency Change
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Currency Change.dll.so
		ptr null; void* handle (0x0)
	}, ; 268
	...
	%struct.DSOCacheEntry {
		i64 2255957048, ; hash 0x86772c38, from name: Currency Change
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Currency Change.dll.so
		ptr null; void* handle (0x0)
	}, ; 339
	...
	%struct.DSOCacheEntry {
		i64 3572235060, ; hash 0xd4ebfb34, from name: libaot-Currency Change
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Currency Change.dll.so
		ptr null; void* handle (0x0)
	}, ; 536
